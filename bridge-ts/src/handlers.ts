...
const HANDLERS: Record<string, MessageHandler> = {
  // Core handlers
  [M.MSG_HELLO]: handleHello,
  [M.MSG_PING]: handlePing,
  
  // Server store handlers (legacy HTTP servers)
  [M.MSG_ADD_SERVER]: handleAddServer,
  [M.MSG_REMOVE_SERVER]: handleRemoveServer,
  [M.MSG_LIST_SERVERS]: handleListServers,
  [M.MSG_CONNECT_SERVER]: handleConnectServer,
  [M.MSG_DISCONNECT_SERVER]: handleDisconnectServer,
  [M.MSG_LIST_TOOLS]: handleListTools,
  [M.MSG_LIST_RESOURCES]: handleListResources,
  [M.MSG_LIST_PROMPTS]: handleListPrompts,
  [M.MSG_CALL_TOOL]: handleCallTool,
  
  // Catalog handlers
  [M.MSG_CATALOG_GET]: handleCatalogGet,
  [M.MSG_CATALOG_REFRESH]: handleCatalogRefresh,
  [M.MSG_CATALOG_SEARCH]: handleCatalogSearch,
  [M.MSG_CATALOG_ENRICH]: handleCatalogEnrich,
  
  // Curated directory handlers
  [M.MSG_GET_CURATED_SERVERS]: handleGetCuratedServers,
  [M.MSG_GET_CURATED_LIST]: handleGetCuratedList,
  [M.MSG_INSTALL_CURATED_SERVER]: handleInstallCuratedServer,
  [M.MSG_INSTALL_CURATED]: handleInstallCurated,
  [M.MSG_INSTALL_GITHUB_REPO]: handleInstallGithubRepo,
  [M.MSG_INSTALL_FROM_GITHUB]: handleInstallFromGitHub,
  
  // Docker handlers
  [M.MSG_CHECK_DOCKER]: handleCheckDocker,
  [M.MSG_RECONNECT_ORPHANED_CONTAINERS]: handleReconnectOrphanedContainers,
  ...
  [M.MSG_INSTALL_SERVER]: handleInstallServer,
  [M.MSG_ADD_REMOTE_SERVER]: handleAddRemoteServer,
  [M.MSG_IMPORT_CONFIG]: handleImportConfig,
  [M.MSG_RESOLVE_GITHUB]: handleResolveGitHub,
  [M.MSG_RESOLVE_SERVER_PACKAGE]: handleResolveServerPackage,
  [M.MSG_UNINSTALL_SERVER]: handleUninstallServer,
  [M.MSG_LIST_INSTALLED]: handleListInstalled,
  [M.MSG_START_INSTALLED]: handleStartInstalled,
  [M.MSG_STOP_INSTALLED]: handleStopInstalled,
  [M.MSG_SET_SERVER_SECRETS]: handleSetServerSecrets,
  [M.MSG_UPDATE_SERVER_ARGS]: handleUpdateServerArgs,
  [M.MSG_GET_SERVER_STATUS]: handleGetServerStatus,
  
  // Manifest-based installation handlers
  [M.MSG_INSTALL_FROM_MANIFEST]: handleInstallFromManifest,
  [M.MSG_CHECK_MANIFEST_OAUTH]: handleCheckManifestOAuth,
  [M.MSG_MANIFEST_OAUTH_START]: handleManifestOAuthStart,
  [M.MSG_MANIFEST_OAUTH_STATUS]: handleManifestOAuthStatus,
  [M.MSG_START_MANIFEST_SERVER]: handleStartManifestServer,
  [M.MSG_GET_SERVER_MANIFEST]: handleGetServerManifest,
  [M.MSG_GET_OAUTH_CAPABILITIES]: handleGetOAuthCapabilities,
  
  // MCP stdio handlers (for locally installed servers)
  [M.MSG_MCP_CONNECT]: handleMcpConnect,
  [M.MSG_MCP_DISCONNECT]: handleMcpDisconnect,
  [M.MSG_MCP_LIST_CONNECTIONS]: handleMcpListConnections,
  [M.MSG_MCP_LIST_TOOLS]: handleMcpListTools,
  [M.MSG_MCP_LIST_RESOURCES]: handleMcpListResources,
  [M.MSG_MCP_LIST_PROMPTS]: handleMcpListPrompts,
  [M.MSG_MCP_CALL_TOOL]: handleMcpCallTool,
  [M.MSG_MCP_READ_RESOURCE]: handleMcpReadResource,
  [M.MSG_MCP_GET_PROMPT]: handleMcpGetPrompt,
  [M.MSG_MCP_GET_LOGS]: handleMcpGetLogs,
  
  // Credential handlers
  [M.MSG_SET_CREDENTIAL]: handleSetCredential,
  [M.MSG_GET_CREDENTIAL_STATUS]: handleGetCredentialStatus,
  [M.MSG_VALIDATE_CREDENTIALS]: handleValidateCredentials,
  [M.MSG_DELETE_CREDENTIAL]: handleDeleteCredential,
  [M.MSG_LIST_CREDENTIALS]: handleListCredentials,
  
  // OAuth handlers
  [M.MSG_OAUTH_START]: handleOAuthStart,
  [M.MSG_OAUTH_CANCEL]: handleOAuthCancel,
  [M.MSG_OAUTH_REVOKE]: handleOAuthRevoke,
  [M.MSG_OAUTH_STATUS]: handleOAuthStatus,
  [M.MSG_LIST_OAUTH_PROVIDERS]: handleListOAuthProviders,
  
  // Host API handlers
  [M.MSG_HOST_GRANT_PERMISSION]: handleHostGrantPermission,
  [M.MSG_HOST_REVOKE_PERMISSION]: handleHostRevokePermission,
  [M.MSG_HOST_CHECK_PERMISSION]: handleHostCheckPermission,
  [M.MSG_HOST_GET_PERMISSIONS]: handleHostGetPermissions,
  [M.MSG_HOST_EXPIRE_TAB_GRANTS]: handleHostExpireTabGrants,
  [M.MSG_HOST_LIST_TOOLS]: handleHostListTools,
  [M.MSG_HOST_CALL_TOOL]: handleHostCallTool,
  [M.MSG_HOST_GET_STATS]: handleHostGetStats,
  
  // LLM handlers
  [M.MSG_LLM_DETECT]: handleLlmDetect,
  [M.MSG_LLM_LIST_PROVIDERS]: handleLlmListProviders,
  [M.MSG_LLM_SET_ACTIVE]: handleLlmSetActive,
  [M.MSG_LLM_SET_MODEL]: handleLlmSetModel,
  [M.MSG_LLM_LIST_MODELS]: handleLlmListModels,
  [M.MSG_LLM_LIST_MODELS_FOR]: handleLlmListModelsFor,
  [M.MSG_LLM_CHAT]: handleLlmChat,
  [M.MSG_LLM_GET_ACTIVE]: handleLlmGetActive,
  [M.MSG_LLM_SET_API_KEY]: handleLlmSetApiKey,
  [M.MSG_LLM_REMOVE_API_KEY]: handleLlmRemoveApiKey,
  [M.MSG_LLM_GET_SUPPORTED_PROVIDERS]: handleLlmGetSupportedProviders,
  [M.MSG_LLM_GET_CONFIG]: handleLlmGetConfig,
  
  // LLM setup handlers
  [M.MSG_LLM_SETUP_STATUS]: handleLlmSetupStatus,
  [M.MSG_LLM_DOWNLOAD_MODEL]: handleLlmDownloadModel,
  [M.MSG_LLM_DELETE_MODEL]: handleLlmDeleteModel,
  [M.MSG_LLM_START_LOCAL]: handleLlmStartLocal,
  [M.MSG_LLM_STOP_LOCAL]: handleLlmStopLocal,
  
  // Chat session handlers
  [M.MSG_CHAT_CREATE_SESSION]: handleChatCreateSession,
  [M.MSG_CHAT_SEND_MESSAGE]: handleChatSendMessage,
  [M.MSG_CHAT_GET_SESSION]: handleChatGetSession,
  [M.MSG_CHAT_LIST_SESSIONS]: handleChatListSessions,
  [M.MSG_CHAT_DELETE_SESSION]: handleChatDeleteSession,
  [M.MSG_CHAT_UPDATE_SESSION]: handleChatUpdateSession,
  [M.MSG_CHAT_CLEAR_MESSAGES]: handleChatClearMessages,
};
