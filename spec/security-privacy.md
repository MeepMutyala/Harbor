...
Report implementation-specific vulnerabilities to the relevant implementation maintainers. For Harbor (the reference implementation), follow the same process above.
